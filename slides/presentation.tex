...
\begin{frame}{运行失败文件}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.75\textwidth]{figures/run_fail.png}
  \end{figure}
...
\begin{frame}{运行结果文件夹}
  ...
  \begin{columns}[T]
    \column{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/result_dir1.png}

    \column{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/result_dir2.png}
  \end{columns}
...
\begin{frame}{实验结果}
  ...
  \begin{columns}[T]
    \column{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/perf_plain_ds.png}

    {\small plain}

    \column{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/perf_noisy_ds.png}
