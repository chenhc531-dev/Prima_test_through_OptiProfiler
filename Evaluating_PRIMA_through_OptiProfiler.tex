...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/perf_plain_ds.png}
    \caption{Performance profiles for double and single precision on the plain problem set.}
    \label{fig:perf_plain_ds}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/perf_noisy_ds.png}
    \caption{Performance profiles for double and single precision on the noisy problem set.}
    \label{fig:perf_noisy_ds}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/perf_plain_dq.png}
    \caption{Performance profiles for double and quadruple precision on the plain problem set.}
    \label{fig:perf_plain_dq}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/perf_noisy_dq.png}
    \caption{Performance profiles for double and quadruple precision on the noisy problem set.}
    \label{fig:perf_noisy_dq}
\end{figure}

Figure~\ref{fig:perf_plain_ds} and Table~\ref{tab:ds_plain} compare
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/data_plain_ds.png}
    \caption{Data profiles for double and single precision on the plain problem set at tolerance $10^{-10}$.}
    \label{fig:data_plain_ds}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/data_noisy_ds.png}
    \caption{Data profiles for double and single precision on the noisy problem set.}
    \label{fig:data_noisy_ds}
\end{figure}

% --- Log-Ratio Profiles ---
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/logratio_plain_ds.png}
    \caption{Log-ratio profiles for double and single precision on the plain problem set.}
    \label{fig:logratio_plain_ds}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/logratio_noisy_ds.png}
    \caption{Log-ratio profiles for double and single precision on the noisy problem set.}
    \label{fig:logratio_noisy_ds}
\end{figure}
